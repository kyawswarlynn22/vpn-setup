  ...
  const socials = [
    {
      ...
      label: "TikTok",
      value: "@coder_02",
      href: "https://www.tiktok.com/@coder_02",
      color: "bg-[#010101]",
    ...
    },
    {
      ...
      label: "Viber",
      value: "+95 9790655699",
      href: "viber://chat?number=%2B959790655699",
      color: "bg-[#7360F2]",
      textColor: "text-white",
    },
    {
    ...
    },
    {
      icon: GmailIcon,
      label: "Gmail",
      value: "kyawswarlynn224@gmail.com",
      href: "mailto:kyawswarlynn224@gmail.com",
      color: "bg-[#EA4335]",
      textColor: "text-white",
    },
  ];
